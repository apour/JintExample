...
// Type: JsonQiifConverterGenerated.Qiif.File
...
[Description("Binary file content and metadata. ")]
public class File
{
  ...
  [JsonProperty("mimeTypeCode", NullValueHandling = NullValueHandling.Ignore)]
  [System.Text.Json.Serialization.JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
  [JsonPropertyName("mimeTypeCode")]
  public Code MimeTypeCode { get; set; }
